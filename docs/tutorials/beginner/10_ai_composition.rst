...
.. admonition:: 💡 Key Concept: Prompt Engineering
   ...
   **Good prompt:**
     "Generate a Scalable manifest for an energy modeling workflow with:
...
.. code-block:: bash
   ...
   scalable compose \
     --description "Energy modeling pipeline with GridLAB-D simulation \
...
.. code-block:: yaml
   ...
   # Migration notes:
   # - Slurm 'queue: batch' → K8s namespace 'team-energy'
